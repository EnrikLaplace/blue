...
import blue.lang.json.JsonIOException;
import blue.lang.json.JsonNull;
...
import blue.lang.json.internal.LazilyParsedNumber;
...
public final class TypeAdapters {
  ...
  public static <T1> TypeAdapterFactory newTypeHierarchyFactory(
    ...
    return new TypeAdapterFactory() {
      ...
      public <T2> TypeAdapter<T2> create(Json gson, TypeToken<T2> typeToken) {
