...
import blue.lang.json.internal.LinkedTreeMap;
...
public final class JsonObject extends JsonElement implements Iterable<Map.Entry<String, JsonElement>> {
  ...
  public JsonElement get(String memberName) {
      if(members.get(memberName) instanceof JsonNull){
          return null;
      }
  ...
  public JsonArray getAsJsonArray(String memberName, boolean nullSafe) {
      JsonArray ret = getAsJsonArray(memberName);
      if(ret == null && nullSafe){
