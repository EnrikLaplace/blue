 ...
 * <p>
 * To get a new Connection, use {@link blue.lang.html.Html#connect(String)}. Connections contain {@link Connection.Request}
...
public interface Connection {
     ...
     * @return this Connection, for chaining
     * @see blue.lang.html.helper.HttpConnection#DEFAULT_UA
     */
     ...
     * @return this Connection, for chaining
     */
    Connection method(HttpMethod method);
     ...
     * @return this Connection, for chaining
     * @see blue.lang.html.Connection.Request#headers()
     */
     ...
     */
    HtmlDocument get() throws IOException;
     ...
     * @throws IOException on error
     */
    HtmlDocument post() throws IOException;
    ...
    interface Response extends Base<Response> {
         ...
         * @throws IOException on error
         */
        HtmlDocument parse() throws IOException;
