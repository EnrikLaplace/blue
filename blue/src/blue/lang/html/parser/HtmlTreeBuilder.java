...
public class HtmlTreeBuilder extends TreeBuilder {
    ...
    private ArrayList<HtmlElement> formattingElements = new ArrayList<HtmlElement>(); // active (open) formatting elements
    ...
    List<Node> parseFragment(String inputFragment, HtmlElement context, String baseUri, ParseErrorList errors, ParseSettings settings) {
        // context may be null
        state = HtmlTreeBuilderState.Initial;
        ...
        if (context != null) {
            ...
            root = new HtmlElement(Tag.valueOf("html", settings), baseUri);
            ...
            for (HtmlElement parent: contextChain) {
    ...
    HtmlElement insert(Token.StartTag startTag) {
        ...
        HtmlElement el = new HtmlElement(Tag.valueOf(startTag.name(), settings), baseUri, settings.normalizeAttributes(startTag.attributes));
        insert(el);
        return el;
    }

    HtmlElement insertStartTag(String startTagName) {
        HtmlElement el = new HtmlElement(Tag.valueOf(startTagName, settings), baseUri);
        insert(el);
        return el;
    }

    void insert(HtmlElement el) {
        insertNode(el);
        stack.add(el);
    }

    HtmlElement insertEmpty(Token.StartTag startTag) {
    ...
    private void insertNode(Node node) {
        ...
        if (node instanceof HtmlElement && ((HtmlElement) node).tag().isFormListed()) {
            if (formElement != null)
                formElement.addElement((HtmlElement) node);
        }
    }
    ...
    private boolean isElementInQueue(ArrayList<HtmlElement> queue, HtmlElement element) {
    ...
    private void replaceInQueue(ArrayList<HtmlElement> queue, HtmlElement out, HtmlElement in) {
    ...
    boolean isSpecial(HtmlElement el) {
    ...
    private boolean isSameFormattingElement(HtmlElement a, HtmlElement b) {
    ...
    void reconstructFormattingElements() {
        ...
        while(true) {
            ...
            HtmlElement newEl = insertStartTag(entry.nodeName()); // todo: avoid fostering here?
