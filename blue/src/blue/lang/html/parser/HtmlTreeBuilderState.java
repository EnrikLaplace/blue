                ...
                case StartTag:
                    ...
                    if (name.equals("a")) {
                        ...
                        if (startTag.attributes.hasKey("action")) {
                            HtmlElement form = tb.getFormElement();
                    ...
                    if (StringUtil.inSorted(name, Constants.InBodyEndAdoptionFormatters)) {
                        ...
                        for (int i = 0; i < 8; i++) {
                            ...
                            for (int j = 0; j < 3; j++) {
                                ...
                                HtmlElement replacement = new HtmlElement(Tag.valueOf(node.nodeName(), ParseSettings.preserveCase), tb.getBaseUri());
                            ...
                            HtmlElement adopter = new HtmlElement(formatEl.tag(), tb.getBaseUri());
