...
import blue.lang.html.nodes.FormElement;
import blue.lang.html.nodes.Node;

import java.util.*;

/**
 A list of {@link HtmlElement}s, with methods that act on every element in the list.
 <p>
 To get an {@code Elements} object, use the {@link HtmlElement#select(String)} method.
 </p>

 @author Jonathan Hedley, jonathan@hedley.net */
public class Elements extends ArrayList<HtmlElement> {
    public Elements() {
    }
    ...
    public Elements(Collection<HtmlElement> elements) {
        super(elements);
    }
    
    public Elements(List<HtmlElement> elements) {
        super(elements);
    }
    
    public Elements(HtmlElement... elements) {
     ...
     * @return this, for chaining
     * @see HtmlElement#tagName(String)
     */
     ...
     * @return this, for chaining
     * @see HtmlElement#prepend(String)
     */
     ...
     * <p>
     * Note that this method should not be used to clean user-submitted HTML; rather, use {@link blue.lang.html.safety.Cleaner} to clean HTML.
     * @return this, for chaining
     * @see HtmlElement#empty()
     * @see #empty()
     */
    ...
    private Elements siblings(String query, boolean next, boolean all) {
        ...
        for (HtmlElement e : this) {
            do {
                HtmlElement sib = next ? e.nextElementSibling() : e.previousElementSibling();
                if (sib == null) break;
                if (eval == null)
                    els.add(sib);
                else if (sib.is(eval))
    ...
    public Elements parents() {
        HashSet<HtmlElement> combo = new LinkedHashSet<HtmlElement>();
        for (HtmlElement e: this) {
