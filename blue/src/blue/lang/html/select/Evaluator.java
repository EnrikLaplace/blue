...
import blue.lang.html.nodes.Comment;
import blue.lang.html.nodes.HtmlDocument;
import blue.lang.html.nodes.DocumentType;
import blue.lang.html.nodes.HtmlElement;
import blue.lang.html.nodes.Node;
import blue.lang.html.nodes.XmlDeclaration;
...
public abstract class Evaluator {
     ...
     */
    public abstract boolean matches(HtmlElement root, HtmlElement element);
    ...
    public static final class AttributeStarting extends Evaluator {
        ...
        @Override
        public boolean matches(HtmlElement root, HtmlElement element) {
            List<blue.lang.html.nodes.Attribute> values = element.attributes().asList();
            for (blue.lang.html.nodes.Attribute attribute : values) {
    ...
    public static final class IsLastChild extends Evaluator {
		@Override
		public boolean matches(HtmlElement root, HtmlElement element) {
			final HtmlElement p = element.parent();
			return p != null && !(p instanceof HtmlDocument) && element.elementSiblingIndex() == p.children().size()-1;
		}
    ...
    public static abstract class CssNthEvaluator extends Evaluator {
    	...
    	public boolean matches(HtmlElement root, HtmlElement element) {
    		final HtmlElement p = element.parent();
    		if (p == null || (p instanceof HtmlDocument)) return false;
		...
		protected abstract int calculatePosition(HtmlElement root, HtmlElement element);
    }
    ...
    public static final class IsNthChild extends CssNthEvaluator {
		...
		protected int calculatePosition(HtmlElement root, HtmlElement element) {
    ...
    public static final class IsFirstChild extends Evaluator {
    	...
    	public boolean matches(HtmlElement root, HtmlElement element) {
    		final HtmlElement p = element.parent();
    		return p != null && !(p instanceof HtmlDocument) && element.elementSiblingIndex() == 0;
    	}
    ...
    public static final class IsRoot extends Evaluator {
    	@Override
    	public boolean matches(HtmlElement root, HtmlElement element) {
    		final HtmlElement r = root instanceof HtmlDocument?root.child(0):root;
    		return element == r;
    	}
    	@Override
    	public String toString() {
    ...
    public static final class IsOnlyChild extends Evaluator {
		...
		public boolean matches(HtmlElement root, HtmlElement element) {
			final HtmlElement p = element.parent();
			return p!=null && !(p instanceof HtmlDocument) && element.siblingElements().size() == 0;
		}
    	@Override
    	public String toString() {
    		return ":only-child";
