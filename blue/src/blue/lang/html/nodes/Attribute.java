...
public class Attribute implements Map.Entry<String, String>, Cloneable  {
    ...
    public String html() {
        ...
        try {
        	html(accum, (new HtmlDocument("")).outputSettings());
    ...
    protected void html(Appendable accum, HtmlDocument.OutputSettings out) throws IOException {
        accum.append(key);
     ...
     */
    protected final boolean shouldCollapseAttribute(HtmlDocument.OutputSettings out) {
        return ("".equals(value) || value.equalsIgnoreCase(key))
                && out.syntax() == HtmlDocument.OutputSettings.Syntax.html
                && isBooleanAttribute();
    }
