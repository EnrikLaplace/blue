...
public class HtmlDocument extends HtmlElement {
    ...
    public HtmlElement createElement(String tagName) {
        return new HtmlElement(Tag.valueOf(tagName, ParseSettings.preserveCase), this.baseUri());
    }
    ...
    private HtmlElement findFirstElementByTagName(String tag, Node node) {
    ...
    public HtmlDocument clone() {
        HtmlDocument clone = (HtmlDocument) super.clone();
    ...
    private void ensureMetaCharsetElement() {
        if (updateMetaCharset) {
            ...
            if (syntax == OutputSettings.Syntax.html) {
                HtmlElement metaCharset = select("meta[charset]").first();
     ...
     */
    public HtmlDocument outputSettings(OutputSettings outputSettings) {
