...
public final class DataUtil {
     ...
     */
    public static HtmlDocument load(File in, String charsetName, String baseUri) throws IOException {
     ...
     * @throws IOException on IO error
     */
    public static HtmlDocument load(InputStream in, String charsetName, String baseUri) throws IOException {
     ...
     * @throws IOException on IO error
     */
    public static HtmlDocument load(InputStream in, String charsetName, String baseUri, Parser parser) throws IOException {
        ByteBuffer byteData = readToByteBuffer(in);
    ...
    static HtmlDocument parseByteData(ByteBuffer byteData, String charsetName, String baseUri, Parser parser) {
        String docData;
        ...
        if (charsetName == null) { // determine from meta. safe first parse as UTF-8
            ...
            HtmlElement meta = doc.select("meta[http-equiv=content-type], meta[charset]").first();
